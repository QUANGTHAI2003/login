...
if (isset($_POST['add_to_cart'])) {
    ...
    $select_cart = mysqli_query($conn, "SELECT * FROM `cart` WHERE name = '$product_name' AND user_id = '$user_id'") or die(header('location:login.php'));

    if (mysqli_num_rows($select_cart) > 0) {
        $message[] = 'product already added to cart!';
    } else {
        mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price, image, quantity) VALUES('$user_id', '$product_name', '$product_price', '$product_image', '$product_quantity')") or die(header('location:login.php'));
...
?>
    ...
    <div class="container">
        ...
        <div class="user-profile">
            ...
            <p> Username : <span><?php echo $fetch_user['name']; ?></span>
            </p>
            <p> Email : <span><?php echo $fetch_user['email']; ?></span>
            </p>
            <div class="flex">
        ...
        <div class="products">
            ...
            <div class="box-container">
                ...
                <form method="post" class="box" action="">
                    ...
                    <div class="name"><?php echo $fetch_product['name']; ?>
                    </div>
        ...
        <div class="shopping-cart">
            ...
            <div class="cart-btn">
                <a href="#" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">proceed
                    to checkout</a>
            </div>
        </div>
    </div>
